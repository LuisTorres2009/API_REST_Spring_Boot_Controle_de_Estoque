...
Este projeto estende uma API REST de Controle de Estoque (Spring Boot + JPA) para incorporar um módulo de **Vendas**. A funcionalidade central é a **lógica  de baixa automática do estoque** e o tratamento de erros com *rollback* em caso de insuficiência.
